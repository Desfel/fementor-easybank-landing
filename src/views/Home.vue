<template>
  <div class="page-wrapper">
    ...
    <section class="arguments-section">
      ...
      <div class="arguments">
        <div class="argument">
          <img src="@/assets/img/icon-online.svg" alt="Online Banking" />
        ...
        <div class="argument">
          <img src="@/assets/img/icon-budgeting.svg" alt="Simple Budgeting" />
        ...
        <div class="argument">
          <img src="@/assets/img/icon-onboarding.svg" alt="Fast Onboarding" />
        ...
        <div class="argument">
          <img src="@/assets/img/icon-api.svg" alt="Open API" />
    ...
    <section class="news-section">
      ...
      <div class="news-wrapper">
        <div class="article-card">
          ...
          <div class="article-img" style="background-image: url('../img/image-currency.jpg');"></div>

          <div class="article-content">
            <p class="article-author">By Claire Robinson</p>

            <h3 class="article-title">Receive money in any currency with no fees</h3>
        ...
        <div class="article-card">
          ...
          <div class="article-img" style="background-image: url('../img/image-restaurant.jpg');"></div>

          <div class="article-content">
            <p class="article-author">By Wilson Hutton</p>

            <h3 class="article-title">Treat yourself without worrying about money</h3>
            <p class="article-brief">
        ...
        <div class="article-card">
          ...
          <div class="article-img" style="background-image: url('../img/image-plane.jpg');"></div>

          <div class="article-content">
            <p class="article-author">By Wilson Hutton</p>

            <h3 class="article-title">Take your Easybank card wherever you go</h3>
            <p class="article-brief">
        ...
        <div class="article-card">
          ...
          <div class="article-img" style="background-image: url('../img/image-confetti.jpg');"></div>

          <div class="article-content">
            <p class="article-author">By Claire Robinson</p>

            <h3 class="article-title">Our invite-only Beta accounts are now live!</h3>
            <p class="article-brief">
    ...
    <footer>
      <div class="first-col columns">
        <router-link to="/home">
          <img src="@/assets/img/logo-light.svg" alt="Easybank" />
        </router-link>
